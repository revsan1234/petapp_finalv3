...
export const CustomCursor: React.FC = () => {
    ...
    return (
        <>
            ...
            `}</style>
            <div
                className={`fixed top-0 left-0 pointer-events-none z-[9999] transition-transform duration-100 ease-out will-change-transform flex items-center justify-center ${isHidden ? 'opacity-0' : 'opacity-100'}`}
                style={{
            ...
            >
                ...
                >
                    {/* Heart SVG - Updated fill to Sage Green (#8da38d) */}
                    <svg 
                        width="24" 
                        height="24" 
                        viewBox="0 0 24 24" 
