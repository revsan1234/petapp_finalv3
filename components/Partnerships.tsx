...
const DogMascot = () => (
  <PetCharacter pet="dog" className="w-32 h-32 drop-shadow-md" />
);
const CatMascot = () => (
  <PetCharacter pet="cat" className="w-32 h-32 drop-shadow-md" />
);
const RabbitMascot = () => (
  <PetCharacter pet="rabbit" className="w-32 h-32 drop-shadow-md" />
);
const HamsterMascot = () => (
  <PetCharacter pet="hamster" className="w-32 h-32 drop-shadow-md" />
);
const BirdMascot = () => (
...
const AmazonProductCard: React.FC<{
  ...
  buttonText: string;
}> = ({ title, link, description, Illustration, buttonText }) => (
  <div className="bg-gradient-to-b from-white/80 to-white/40 backdrop-blur-md rounded-2xl p-6 text-center flex flex-col h-full text-[#333333] border border-white/50 transition-all hover:scale-105 hover:shadow-xl shadow-md active:scale-95 relative overflow-hidden group">
    ...
    <h3
      className="text-3xl font-black mb-3 flex-grow text-[#5F6F5F]"
      ...
      <div className="relative z-10">
        ...
        <main className="py-4 md:py-8 px-4 sm:px-6 md:px-8 pb-24">
          ...
          <div className="container mx-auto flex flex-col items-center justify-center mb-12">
            <p className="text-white text-2xl mt-2 font-bold drop-shadow-md">
              {t.shop.subtitle}
            </p>
          </div>
